...
$id = $_GET['id'];
$query = $con->query(" SELECT * FROM mcu_mata m JOIN pasien p ON p.id_pasien = m.id_pasien WHERE id_mcu_mata ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-eye ml-1 mr-1"></i> Verifikasi Data Diagnosa Mata</h4>
                </div><!-- /.col -->
                    ...
                    <div class="card card-olive card-outline">
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Cacat Mata</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cacat" class="form-control" value="<?= $row['cacat'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE mcu_mata SET 
        buta = '$buta',
        cacat = '$cacat',
        catatan = '$catatan',
        verif = 1
