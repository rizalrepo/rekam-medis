                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM mcu_mata m JOIN pasien p ON p.id_pasien = m.id_pasien WHERE id_dokter = '$log[id_dokter]' AND verif = 0 ORDER BY id_mcu_mata DESC");
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM mcu_mata m JOIN pasien p ON p.id_pasien = m.id_pasien WHERE id_dokter = '$log[id_dokter]' AND verif = 1 ORDER BY id_mcu_mata DESC");
                                        while ($row = $data->fetch_array()) {
                                        ?>
                                            <tr>
                                                <td align="center" width="5%"><?= $no++ ?></td>
