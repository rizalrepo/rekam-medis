        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="custom-width-modalLabel"> <button type="button" class="btn btn-default waves-effect" data-dismiss="modal"><i class="fa fa-info-circle"></i></button> Detail Data Diagnosa Mata</h5>
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal"><i class="fa fa-window-close"></i></button>
                </div>
                <?php
                $q = $con->query("SELECT * FROM mcu_mata m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter JOIN user u ON u.id_user = m.id_user WHERE id_mcu_mata = '$id' ");
                $d = $q->fetch_array();
                        ...
                        <div class="form-group">
                            ...
                            <div class="card-body" style="text-align: left;">
                                ...
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-3">Buta Mata</dt>
                                    <dd class="col-sm-9">: <?= $d['buta'] ?></dd>
                                    <dt class="col-sm-3">Cacat Mata</dt>
