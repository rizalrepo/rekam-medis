...
<head>
    <title>Laporan Data MCU NAPZA</title>
</head>
                    ...
                    <tbody>
                        <?php while ($data = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <!-- <td align="center"><?= $data['methamphetamine'] ?></td>
                                <td align="center"><?= $data['amphetamine'] ?></td>
                                <td align="center"><?= $data['benzodiazepine'] ?></td>
                                <td align="center"><?= $data['thc'] ?></td>
                                <td align="center"><?= $data['morphine'] ?></td>
                                <td align="center"><?= $data['cocaine'] ?></td> -->
                                <td><?= $data['hasil'] ?></td>
                                <td><?= $data['catatan'] ?></td>
