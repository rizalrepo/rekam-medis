...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="mdi mdi-human-handsup ml-1 mr-1"></i> Data Diagnosa NAPZA</h4>
                </div><!-- /.col -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM mcu_napza m JOIN pasien p ON p.id_pasien = m.id_pasien WHERE id_dokter = '$log[id_dokter]' AND verif = 0 ORDER BY id_mcu_napza  DESC");
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM mcu_napza m JOIN pasien p ON p.id_pasien = m.id_pasien WHERE id_dokter = '$log[id_dokter]' AND verif = 1 ORDER BY id_mcu_napza DESC");
                                        while ($row = $data->fetch_array()) {
                                        ?>
                                            <tr>
                                                <td align="center" width="5%"><?= $no++ ?></td>
