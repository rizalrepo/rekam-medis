...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="mdi mdi-virus ml-1 mr-1"></i> Data Diagnosa Virus</h4>
                </div><!-- /.col -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['nm_pasien'] ?></td>
                                                <td align="center"><?= tgl_indo($row['tanggal']) ?></td>
                                                <td align="center"><?= $row['covid'] ?></td>
                                                <td align="center"><?= $row['hepatitis'] ?></td>
                                                <td align="center"><?= $row['hiv'] ?></td>
                                                <td align="center" width="13%">
                                                    <a href="#id<?= $row[0]; ?>" data-toggle="modal" class="btn bg-purple btn-xs" title="Detail"><i class="fa fa-info-circle"></i></a>
