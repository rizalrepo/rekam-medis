...
$query = $con->query("SELECT * FROM mcu_hamil m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter JOIN user u ON u.id_user = m.id_user WHERE id_mcu_hamil = '$id' ");
...
<head>
    <title>Surat Keterangan MCU Kehamilan</title>
</head>
    ...
    <div class="table-responsive">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td align="center">
                    <h2>SURAT KETERANGAN MCU KEHAMILAN</h2>
