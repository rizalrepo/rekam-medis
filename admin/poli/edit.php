...
$id = $_GET['id'];
$query = $con->query(" SELECT * FROM poli WHERE id_poli ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-hospital ml-1 mr-1"></i> Edit Data Poli</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nm_poli" value="<?= $row['nm_poli'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE poli SET 
        nm_poli = '$nm_poli', 
        ket = '$ket'
        WHERE id_poli = '$id'
    ");
