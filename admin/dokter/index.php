...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-user-md ml-1 mr-1"></i> Data Dokter</h4>
                </div><!-- /.col -->
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM dokter ORDER BY id_dokter DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <b>Nama</b> : <?= $row['nm_dokter'] ?><br>
                                                    <b>NIP</b> : <?= $row['nip'] ?><br>
                                                    <b>SIP</b> : <?= $row['sip'] ?><br>
                                                </td>
                                                <td align="center"><?= $row['spesialis'] ?></td>
