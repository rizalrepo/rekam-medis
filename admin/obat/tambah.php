                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kekuatan" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Bentuk</label>
                                    <div class="col-sm-10">
                                        <?= form_dropdown('bentuk', $bentuk, '', 'class="form-control" required') ?>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO obat VALUES (
        '', 
        '$nm_obat', 
        '$kekuatan',
        '$bentuk',
