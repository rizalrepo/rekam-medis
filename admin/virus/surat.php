...
$query = $con->query("SELECT * FROM mcu_virus m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter JOIN user u ON u.id_user = m.id_user WHERE id_mcu_virus = '$id' ");
...
<head>
    <title>Surat Keterangan MCU Virus</title>
</head>
...
<body>
    <div class="table-responsive">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td align="center">
                    <h2>SURAT KETERANGAN MCU VIRUS</h2>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td width="25%"><b>Covid 19</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['covid'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>Hepatitis</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['hepatitis'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>HIV</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['hiv'] ?></td>
        </tr>
        <tr>
