...
$query =  $con->query("SELECT * FROM mcu_fisik m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter JOIN user u ON u.id_user = m.id_user WHERE id_mcu_fisik = '$id' ");
...
<head>
    <title>Surat Keterangan MCU Jantung & Fisik</title>
</head>
...
<body>
    <div class="table-responsive">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td align="center">
                    <h2>SURAT KETERANGAN MCU JANTUNG & FISIK</h2>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td width="25%"><b>EKG</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['ekg'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>Tatto</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['tatto'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>Cacat Fisik</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['cacat'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>Laik Terbang</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['terbang'] ?></td>
        </tr>
        <tr>
