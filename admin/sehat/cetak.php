...
if (isset($_POST['cetak'])) {
    ...
    if ($tgl1 == $cektgl1 && $tgl2 == $cektgl2 && $id_dokter == null) {
        ...
        $sql1 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.tanggal BETWEEN '$tgl1' AND '$tgl2' AND jk = 'Laki-laki' ORDER BY id_mcu_sehat DESC");
        $sql2 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.tanggal BETWEEN '$tgl1' AND '$tgl2' AND jk = 'Perempuan' ORDER BY id_mcu_sehat DESC");
        ...
        $sql1 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.id_dokter = '$id_dokter' AND jk = 'Laki-laki' ORDER BY id_mcu_sehat DESC");
        $sql2 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.id_dokter = '$id_dokter' AND jk = 'Perempuan' ORDER BY id_mcu_sehat DESC");
        ...
        $sql1 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.tanggal BETWEEN '$tgl1' AND '$tgl2' AND m.id_dokter = '$id_dokter' AND jk = 'Laki-laki' ORDER BY id_mcu_sehat DESC");
        $sql2 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE m.tanggal BETWEEN '$tgl1' AND '$tgl2' AND m.id_dokter = '$id_dokter' AND jk = 'Perempuan' ORDER BY id_mcu_sehat DESC");
        ...
        $sql1 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE jk = 'Laki-laki' ORDER BY id_mcu_sehat DESC");
        $sql2 = mysqli_query($con, "SELECT * FROM mcu_sehat m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter WHERE jk = 'Perempuan' ORDER BY id_mcu_sehat DESC");
