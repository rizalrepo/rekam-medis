...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-eye ml-1 mr-1"></i> Tambah Data Diagnosa Mata</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="buta" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Cacat Mata</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cacat" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO mcu_mata VALUES (
        '',
        '$id_pasien', 
        '$untuk', 
        '$tanggal', 
