...
$query = $con->query("SELECT * FROM mcu_mata m JOIN pasien p ON p.id_pasien = m.id_pasien JOIN dokter d ON d.id_dokter = m.id_dokter JOIN user u ON u.id_user = m.id_user WHERE id_mcu_mata = '$id' ");
...
<head>
    <title>Surat Keterangan MCU Mata</title>
</head>
...
<body>
    <div class="table-responsive">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td align="center">
                    <h2>SURAT KETERANGAN MCU MATA</h2>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td width="25%"><b>Buta Mata</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['buta'] ?></td>
        </tr>
        <tr>
            <td width="25%"><b>Cacat Mata</b></td>
            <td align="center" width="4%">:</td>
            <td><?= $row['cacat'] ?></td>
        </tr>
        <tr>
