...
$query = mysqli_query($con, "SELECT max(id_rm) as kode FROM rm");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-stethoscope ml-1 mr-1"></i> Tambah Data Rekam Medis</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="id_rm" value="<?= $kode ?>" required readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="id_poli" class="form-control select2" style="width: 100%;">
                                            ...
                                            <?php $data = $con->query("SELECT * FROM poli ORDER BY id_poli DESC"); ?>
                                            <?php foreach ($data as $row) : ?>
                                                <option value="<?= $row['id_poli'] ?>"><?= $row['nm_poli'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO rm VALUES (
        '$id_rm', 
        '$id_pasien', 
        '$tanggal', 
        '$id_poli',
